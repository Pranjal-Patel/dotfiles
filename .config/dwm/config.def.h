...
#if BAR_PANGO_PATCH
// static const char font[]                 = "JetBrainsMono-Regular:size=10";
static const char font[]                 = "monospace:size=10";
#else
static const char *fonts[]               = { "JetBrainsMono-Regular:size=10", "monospace:size=10" };
...
static char selbgcolor[]                 = "#e46f22";
static char selbordercolor[]             = "#e46f22";
...
static char tagsselbgcolor[]             = "#e46f22";
static char tagsselbordercolor[]         = "#00bb00";
...
static const Key keys[] = {
	/* modifier                     key            function                argument */
	#if KEYMODES_PATCH
	{ MODKEY|ShiftMask,             XK_Escape,     setkeymode,             {.ui = COMMANDMODE} },
